...
\[
\inference{C <: \mathsf{dom}(B) & \mathsf{cod}(B) <: D}
          {A <: C \to D}
          {\small \mathsf{graph}(B) \subseteq \mathsf{graph}(A)}
\]
where
\[
...
%===============================================================================
\frame{
\frametitle{Solution: Yet Another Formulation}
...
%===============================================================================
\frame{
  \frametitle{Challenge: Repetative Metatheory!}
...
We've been using filter models, but the graph models are a better fit
for the generic theorems about ABTs.
...
\frame{
  ...
  \begin{itemize}
  \item Intersection types make great denotational semantics.
  \item Compilation correctness is a challenging application.  We still
    have a long ways to go to put all these pieces together.
  \item Generic syntax and metatheory may help us
