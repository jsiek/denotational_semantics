...
\frame{
  ...
  \item Compilation of a Functional Language
...
%   \SEM{c}\rho &= \Delta\SEM{c} \\
   ...
   \SEM{\lambda x. N}\rho &= \{ u \mid \forall v {\mapsto} w \in \mathsf{graph}(u), \\
...
%===============================================================================
\frame{
  \frametitle{Compilation of a Functional Language}
...
&f \app w \\
& \Downarrow \\
& \mathbf{fun}~ g(v, z) = \mathsf{fst}\, v + \mathsf{snd}\, v + z \\
&\LET w = 5, x = 3, y = 3 \IN \\
&\LET f = \langle g, \langle x , y \rangle \rangle \IN \\
&(\mathsf{fst}\, f) \app (\mathsf{snd}\, f) \app w
\end{align*}
...
\begin{itemize}
\item If $\rho_1 \sqsubseteq \rho_2$, then $\SEM{M}\rho_1 \subseteq
  \SEM{M}\rho_2$.
\item If $v \in \SEM{M}\rho$ and $w \sqsubseteq v$,
  then $w \in \SEM{M}\rho$.
\item If $v_1 \in \SEM{M}\rho$ and $v_2 \in \SEM{M}\rho$, then $v_1
  \sim v_2$.
\item If $v_1 \in \SEM{M}\rho$ and $v_2 \in \SEM{M}\rho$, then $v_1
...
%===============================================================================
\frame{
\frametitle{Solution: Another Formulation}
...
\begin{align*}
&\LET w = 5, x = 3, y = 3 \IN \\
&\LET f = (\lambda x y, z.~ x + y + z)\rd{@}\langle x,y\rangle \IN \\
&f \app w \\
& \Downarrow \\
&\LET w = 5, x = 3, y = 3 \IN \\
&\LET f = \langle (\lambda x y, z.~ x + y + z), \langle x , y \rangle \rangle \IN \\
...
\frame{
  ...
  \item Generic syntax and metatheory is helping us manage the
    complexity.
  \end{itemize}
