...
\frame{
  ...
  \item Our denotations $\mathbb{D}$ and ordering $\sqsubseteq$ can be
    viewed as a simple form of intersection type and subtyping.
...
$\sqsubseteq$. But with intersection types, not so much.\\[2ex]
...
%===============================================================================
\frame{
  \frametitle{Olivier's Subtyping}
...
\begin{gather*}
  ...
  \inference{\Sigma_1, \Sigma_2 \vdash A}
   ...
   \inference{}{n \vdash n}
   \qquad
   \inference{A \vdash C_1, \ldots, C_n \quad
...
%===============================================================================
\frame{
  \frametitle{The Road to Transitivity}
...
\frame{
  ...
  \begin{itemize}
  \item Restricting the tables to be ``functional'' gives us
