...
\begin{abstract}
  ...
  transitivity. The new system satisfies something like the subformula
  property: every type occuring in the subtyping derivation of $A <:
  ...
  choice of induction principle for the proof of transitivity is
  subtle: we use well-founded induction on the lexicographical
  ordering of the sum of the depths of the first and last type
  followed by the sum of the sizes of the middle and last type. The
  article concludes with a proof that the new subtyping judgment is
