...
\begin{abstract}
  ...
  types is essentially the $\beta$-soundness property. The article
  proves that the new subtyping system is equivalent to that of
...
codomain.
%
The relations $A \inside B$ and $A \containedin B$ enable the treatment
...
\emph{contains} $A$ if $A \containedin B$.
