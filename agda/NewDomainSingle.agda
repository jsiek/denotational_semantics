...
data Value : Set where
  ...
  ⦅_,_⦆ :             {- Closure Representations are just pairs -}
...
clos-inj : ∀ {d₁ d₂ d₁' d₂'} → ⦅ d₁ , d₂ ⦆ ≡ ⦅ d₁' , d₂' ⦆ → d₁ ≡ d₁' × d₂ ≡ d₂'
clos-inj refl = ⟨ refl , refl ⟩

clos-inj-uncurried : ∀ {d₁ d₂ d₁' d₂'} → ⦅ d₁ , d₂ ⦆ ≡ ⦅ d₁' , d₂' ⦆ 
  → ⟨ d₁ , d₂ ⟩ ≡ ⟨ d₁' , d₂' ⟩
...
ω d≟  (right v) = no (λ ())
⦅ d₁ , d₂ ⦆ d≟ const k = no (λ ())
⦅ d₁ , d₂ ⦆ d≟ (d₂' ∷ FV₁ ⊢ v ∷ V ↦ d₃) = no (λ ())
⦅ d₁ , d₂ ⦆ d≟ (fv' ∷ FV' ⊢ν) = no (λ ())
⦅ d₁ , d₂ ⦆ d≟ ω = no (λ ())
⦅ d₁ , d₂ ⦆ d≟ ⦅ d₁' , d₂' ⦆ = 
  map′ (uncurry (cong₂ ⦅_,_⦆)) clos-inj ((d₁ d≟ d₁') ×-dec (d₂ d≟ d₂'))
⦅ d₁ , d₂ ⦆ d≟ ∥ ds ∥ = no (λ ())
⦅ d₁ , d₂ ⦆ d≟ (left v) = no (λ ())
⦅ d₁ , d₂ ⦆ d≟  (right v) = no (λ ())
∥ ds ∥ d≟ const k = no (λ ())
...
ω ~? (left x) = no (λ z → z)
ω ~? (right x) = no (λ z → z)
⦅ d₁' , d₂' ⦆ ~? const x = no (λ z → z)
⦅ d₁' , d₂' ⦆ ~? (fv ∷ x ⊢ v' ∷ V' ↦ v) = no (λ z → z)
⦅ d₁' , d₂' ⦆ ~? (fv ∷ FV ⊢ν) = no (λ z → z)
⦅ d₁' , d₂' ⦆ ~? ω = no (λ z → z)
⦅ d₁ , d₂ ⦆ ~? ⦅ d₁' , d₂' ⦆ = (d₁ ~? d₁') ×-dec (d₂ ~? d₂')
⦅ d₁' , d₂' ⦆ ~? ∥ x ∥ = no (λ z → z)
⦅ d₁' , d₂' ⦆ ~? (left x) = no (λ z → z)
⦅ d₁' , d₂' ⦆ ~? (right x) = no (λ z → z)
∥ x ∥ ~? const x₁ = no (λ z → z)
