...
module Model.Filter.DomainISWIMConsistent where
  ...
  ~-sym (u ↦ u₁) ν u~v = tt
  ~-sym (u ↦ u₁) ω u~v = tt
  ~-sym (u ↦ u₁) (v ↦ v₁) (inj₁ ¬u~v) = inj₁ (λ z → ¬u~v (~-sym v u z))
  ~-sym (u ↦ u₁) (v ↦ v₁) (inj₂ u₁~v₁) = inj₂ (~-sym u₁ v₁ u₁~v₁)
  ~-sym (u ↦ u₁) (v ⊔ v₁) ⟨ u~v , u~v₁ ⟩ =
    ⟨ ~-sym (u ↦ u₁) v u~v , ~-sym (u ↦ u₁) v₁ u~v₁ ⟩
  ...
  consistent-⊑-lemma (⊑-↦-å åu₂ ⊑u ⊑u₁) (v ↦ v₁) (inj₁ x) = inj₁ λ u₁~v → x (consistent-⊑-lemma ⊑u₁ v u₁~v)
  consistent-⊑-lemma (⊑-↦-å åu₂ ⊑u ⊑u₁) (v ↦ v₁) (inj₂ y) = inj₂ (consistent-⊑-lemma ⊑u v₁ y)
