...
delay-preserve (clos-op n ⦅ ! clear (bind (bind (ast N))) ,, fvs ⦆) ρ d 
  ...
  G2 n fvs ω d∈ = tt
  G2 n fvs (d ⊔ d₁) ⟨ d∈ , d₁∈ ⟩ = ⟨ G2 n fvs d d∈ , G2 n fvs d₁ d₁∈ ⟩
  G2 n fvs (tup[ i ] d) ⟨ refl , d∈ ⟩ = ⟨ refl , delay-args-preserve-nth fvs i ρ d d∈ ⟩
  G3 : to FV ∈ OpTarget.𝒯 n (⟦ del-map-args fvs ⟧₊' (env-map to ρ))
  G3 = G2 n fvs FV FV∈𝒯fvs
delay-preserve (clos-op n ⦅ ! clear (bind (bind (ast N))) ,, fvs ⦆) ρ d 
  ⟨ ω , ⟨ FV , ⟨ w , ⟨ w∈ΛN[FV] , ⟨ FV∈𝒯fvs , refl ⟩ ⟩ ⟩ ⟩ ⟩
    | u ⊔ v | ⟨ u∈ΛN[FV] , v∈ΛN[FV] ⟩ = HOLE
...
... | ω | v' = fro ω ⊔ fro v'
... | ν | v' = fro ν ⊔ fro v'
... | const k | v' = fro (const k) ⊔ fro v'
... | u' ⊔ u'' | v' = fro (u' ⊔ u'') ⊔ fro v'
... | u' ↦ u'' | v' = fro (u' ↦ u'') ⊔ fro v'
... | tup[ i ] u' | v' = fro (tup[ i ] u') ⊔ fro v'
... | left u' | v' = fro (left u') ⊔ fro v'
... | right u' | v' = fro (right u') ⊔ fro v'
... | ∣ u' ⦆ | v' = fro ∣ u' ⦆ ⊔ fro v'
... | ⦅ ω ∣ | v' = fro ⦅ ω ∣ ⊔ fro v'
... | ⦅ ν ∣ | v' = fro ⦅ ν ∣ ⊔ fro v'
... | ⦅ const k ∣ | v' = fro ⦅ const k ∣ ⊔ fro v'
...
... | ⦅ left u' ∣ | v' = fro ⦅ left u' ∣ ⊔ fro v'
... | ⦅ right u' ∣ | v' = fro ⦅ right u' ∣ ⊔ fro v'
... | ⦅ FV ↦ (V ↦ w) ∣ | ∣ FV' ⦆ with  FV ⊑? FV'
... | yes FV⊑ = ?
... | no FV⋢ = ?
fro (u ⊔ v) | ⦅ u' ↦ ω ∣ | v' = fro ⦅ u' ↦ ω ∣ ⊔ fro v'
fro (u ⊔ v) | ⦅ u' ↦ ν ∣ | v' = fro ⦅ u' ↦ ν ∣ ⊔ fro v'
fro (u ⊔ v) | ⦅ u' ↦ const k ∣ | v' = fro ⦅ u' ↦ const k ∣ ⊔ fro v'
fro (u ⊔ v) | ⦅ u' ↦ (u'' ⊔ u''') ∣ | v' = fro ⦅ u' ↦ (u'' ⊔ u''') ∣ ⊔ fro v'
fro (u ⊔ v) | ⦅ u' ↦ ⦅ u'' ∣ ∣ | v' = fro ⦅ u' ↦ ⦅ u'' ∣ ∣ ⊔ fro v'
fro (u ⊔ v) | ⦅ u' ↦ ∣ u'' ⦆ ∣ | v' = fro ⦅ u' ↦ ∣ u'' ⦆ ∣ ⊔ fro v'
fro (u ⊔ v) | ⦅ u' ↦ tup[ i ] u'' ∣ | v' = fro ⦅ u' ↦ tup[ i ] u'' ∣ ⊔ fro v'
fro (u ⊔ v) | ⦅ u' ↦ left u'' ∣ | v' = fro ⦅ u' ↦ left u'' ∣ ⊔ fro v'
fro (u ⊔ v) | ⦅ u' ↦ right u'' ∣ | v' = fro ⦅ u' ↦ right u'' ∣ ⊔ fro v'
fro (u ⊔ v) | ⦅ u' ↦ u'' ↦ u''' ∣ | ω = fro ⦅ u' ↦ (u'' ↦ u''') ∣ ⊔ fro ω
fro (u ⊔ v) | ⦅ u' ↦ u'' ↦ u''' ∣ | ν = fro ⦅ u' ↦ (u'' ↦ u''') ∣ ⊔ fro ν
fro (u ⊔ v) | ⦅ u' ↦ u'' ↦ u''' ∣ | const k = fro ⦅ u' ↦ (u'' ↦ u''') ∣ ⊔ fro (const k)
fro (u ⊔ v) | ⦅ u' ↦ u'' ↦ u''' ∣ | v' ⊔ v'' = fro ⦅ u' ↦ (u'' ↦ u''') ∣ ⊔ fro (v' ⊔ v'')
fro (u ⊔ v) | ⦅ u' ↦ u'' ↦ u''' ∣ | v' ↦ v'' = fro ⦅ u' ↦ (u'' ↦ u''') ∣ ⊔ fro (v' ↦ v'')
fro (u ⊔ v) | ⦅ u' ↦ u'' ↦ u''' ∣ | ⦅ v' ∣ = fro ⦅ u' ↦ (u'' ↦ u''') ∣ ⊔ fro ⦅ v' ∣
fro (u ⊔ v) | ⦅ u' ↦ u'' ↦ u''' ∣ | tup[ i ] v' = fro ⦅ u' ↦ (u'' ↦ u''') ∣ ⊔ fro (tup[ i ] v')
fro (u ⊔ v) | ⦅ u' ↦ u'' ↦ u''' ∣ | left v' = fro ⦅ u' ↦ (u'' ↦ u''') ∣ ⊔ fro (left v')
fro (u ⊔ v) | ⦅ u' ↦ u'' ↦ u''' ∣ | right v' = fro ⦅ u' ↦ (u'' ↦ u''') ∣ ⊔ fro (right v')
...
... | left u' | v' = {!   !}
... | right u' | v' = {!   !}
... | ⦅ FV ↦ (V ↦ w) ∣ | ∣ FV' ⦆ with  FV DTarget.d≟ FV'
... | yes refl = {!   !}
... | no neq = {!   !}
...
fro-mono {.(tup[ _ ] _)} (⊑-tup-å åu u⊑v) = DSource.⊑-tup (fro-mono u⊑v)
fro-mono {.(_ ↦ _)} (⊑-↦-å åu₂ u⊑v u⊑v₁) = ⊑-ω
fro-mono {.(left _)} (⊑-left-å åu u⊑v) = DSource.⊑-left (fro-mono u⊑v)
fro-mono {.(right _)} (⊑-right-å åu u⊑v) = DSource.⊑-right (fro-mono u⊑v)
