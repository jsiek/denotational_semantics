...
module Compiler.Correctness.Delay.GoodnessInvariant where
...
{- V ↦ u -} {- un-↦ V ctxt -}
  ...
  un-↦-⊑ {V} (⊑-↦-å {V} {u} {V'} åu₂ u⊑v u⊑v₁) with V' ⊑? V ×-dec V ⊑? V'
  ... | no V'≄V = ⊥-elim (V'≄V ⟨ u⊑v₁ , {!  !} ⟩)
  ... | yes q = u⊑v
...
-}
  ...
  un-↦-mono : ∀ {u v V V'} → u ⊑ v → V ⊑ V' × V' ⊑ V → un-↦ V u ⊑ un-↦ V' v
  un-↦-mono ⊑-ω V'⊑V = ⊑-ω
  un-↦-mono ⊑-ν-ν V'⊑V = ⊑-ω
  un-↦-mono ⊑-ν-↦ V'⊑V = ⊑-ω
  un-↦-mono ⊑-const V'⊑V = ⊑-ω
